...
def create_tfrecord(data_path_dict):
  ...
  for idx, image_fname in enumerate(image_fnames):
    ...
    label_path = os.path.join(label_input, image_fname).replace('image','label_decode') \
                  .replace('.jpg', '.png')
    print(image_path)
    print(label_path)
...
if __name__ == '__main__':
  data_path_dict = {
    "image_input" : "../data_augmented/images/training/",
    "label_input" : "../data_augmented/annotations/training_decode/",
    "tfrecord_output":"../data_tfrecords/",
    "tfrecord_name":"training_data.tfrecord"
    }
